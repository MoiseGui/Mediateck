			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">
						...
						%>
						<jsp:forward page="/Clients"></jsp:forward>
						<%
							} else {
						...
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
									<form method="post" action="ClientEdit"
									...
									<input type="hidden" name="id" value="<%=client.getId()%>">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Nom</label> <input
														type="text" name="nom" value="<%=client.getNom()%>"
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Prénom</label> <input
														type="text" name="prenom" value="<%=client.getPrenom()%>"
														class="form-control" required>
													<div class="valid-feedback">Correct.</div>
										...
										<input type="button"
											class="btn btn-warning pull-left" onclick="javascript:location.href='Clients'" value="Annuler" />
