...
<body class="">
										...
										<table id="fresh-table" class="table">
											...
											<tbody id="myTable">
												...
												<tr>
													...
													<td><%=roles[user.getCategorie()]%></td>
													<td></td>
												</tr>
												<!-- The Modal -->
												<div class="modal" id="myModal<%=user.getId()%>">
														...
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<button type="button" class="btn btn-success"
																	data-dismiss="modal"
																	onClick="javascript:location.href = 'Users?user=<%=user.getId()%>';">Oui</button>
																<!-- 																</a> -->
	...
	<script type="text/javascript">
		...
		function operateFormatter(value, row, index) {
			return [
					'<a rel="tooltip" title="Edit" class="table-action edit" href="UserEdit?edit='
							+ row['id'] + '" title="Edit">',
	...
	<script type="text/javascript">
		md.showNotification('top', 'right', 2,
				'Un problème est survenu lors de la supression de l\'utilisateur.');
	</script>
	<%
		} else if (errorCode > 0) {
	%>
	...
	<script type="text/javascript">
		// 	alert("i am here");
		md.showNotification('top', 'right', 3, 'Utilisateur supprimé avec succès.');
	</script>
	<%
		}
	}
	...
	<script type="text/javascript">
		md.showNotification('top', 'right', 2,
						'Un problème est survenu lors de la sauvegarde des changements sur l\'utilisateur'.');
	</script>
	<%
		} else if (errorCode > 0) {
	%>
