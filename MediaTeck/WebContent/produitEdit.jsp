		...
		<div class="sidebar" data-color="purple" data-background-color="white"
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					...
					<li class="nav-item active"><a class="nav-link" href="Produits">
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">
						...
						%>
						<jsp:forward page="/Produits"></jsp:forward>
						<%
							} else {
						...
						<div class="col-md-8">
							<div class="card">
								<div class="card-header card-header-primary">
									...
									<p class="card-category">Changer les informations
										ci-dessous</p>
								</div>
								<div class="card-body">
									<form method="post" action="ProduitEdit"
										class="needs-validation" novalidate>
									<input type="hidden" name="id" value="<%=produit.getId()%>">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Designation</label> <input
														type="text" name="designation" value="<%=produit.getDesignation()%>"
														class="form-control" required>
													<div class="valid-feedback">Correct.</div>
													<div class="invalid-feedback">Veillez saisir une Designation.</div>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Prix</label> <input
														type="text" name="prix" value="<%=produit.getPrix()%>"
														class="form-control" required>
													<div class="valid-feedback">Correct.</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="bmd-label-floating">Quantité</label> <input
														type="text" name="qte_stock" value="<%=produit.getQte_stock()%>"
														class="form-control" required>
													<div class="valid-feedback">Correct.</div>
													<div class="invalid-feedback">Veillez saisir une
														quantié.</div>
												</div>
											</div>
										</div>
										<input type="button"
											class="btn btn-warning pull-left" onclick="javascript:location.href='Produits'" value="Annuler" />
