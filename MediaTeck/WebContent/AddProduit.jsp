			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand" href="javascript:;">Nouveau produit</a>
					</div>
						...
						<div class="col-md-8">
							<div class="card">
								<div class="card-header card-header-primary">
									...
									<p class="card-category">Mettez les informations du nouveau produit
										ci-dessous</p>
								</div>
								<div class="card-body">
									...
									<input type="hidden" name="id">
										...
										<input type="button"
											class="btn btn-warning pull-left" onclick="javascript:location.href='Produits'" value="Retour" />
...
// 			System.out.print(errorCode);
	...
	<script type="text/javascript">
		...
		md.showNotification('top', 'right', 2,
				'Erreur: un problème est survenu lors de l\'ajout du nouveau produit. Veuillez réessayer plutard.');
	</script>
	<%
		}
	}
